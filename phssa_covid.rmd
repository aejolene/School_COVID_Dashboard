...
# This helps format dates.
date_stamp <- stamp("12/31/2021 2:03PM")
...
Data is updated by the PHSSA Board as soon as it is verified.
...
mostRecentUpdate <- date_stamp(max(ph_data$edited, na.rm = TRUE))
